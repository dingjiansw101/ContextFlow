...
def summarize_nnx_model(
    ...
    output_path: str = "model_structure_mini_summary.json"
):
...
def init_train_state(
    ...
    def init(rng: at.KeyArrayLike, partial_params: at.Params | None = None) -> training_utils.TrainState:
        ...
        #     summarize_nnx_model(model, config.freeze_filter, output_path="model_structure_mini_summary.json")
...
def main(config: _config.TrainConfig):
    ...
    #XJ: debug
    logging.info(f"[Init] train_state.params.model.PaliGemma.llm: {training_utils.array_tree_to_info(train_state.params['PaliGemma']['llm'])}")
