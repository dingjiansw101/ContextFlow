...
class Pi0IncontextConfigv12Dummy(_model.BaseModelConfig):
    ...
    @override
    def create(self, rng: at.KeyArrayLike) -> "Pi0Incontextv12Dummy":
        return Pi0Incontextv12Dummy(self, rngs=nnx.Rngs(rng))
...
class Pi0Incontextv12Dummy(_model.BaseModel):
    def __init__(self, config: Pi0IncontextConfigv12Dummy, rngs: nnx.Rngs):
        ...
        if self.use_point_track_prompts:
            self.demo_track_proj = nnx.Linear(config.point_track_dim, prompt_expert_config.width, rngs=rngs)
