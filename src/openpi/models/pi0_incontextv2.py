...
class Pi0IncontextConfigv2(_model.BaseModelConfig):
    dtype: str = "bfloat16"
    ...
    @override
    def create(self, rng: at.KeyArrayLike) -> "Pi0Incontextv2":
        return Pi0Incontextv2(self, rngs=nnx.Rngs(rng))
...
class Pi0Incontextv2(_model.BaseModel):
    def __init__(self, config: Pi0IncontextConfigv2, rngs: nnx.Rngs):
