...
class Pi0IncontextConfigv4(_model.BaseModelConfig):
    dtype: str = "bfloat16"
    ...
    @override
    def create(self, rng: at.KeyArrayLike) -> "Pi0Incontextv4":
        return Pi0Incontextv4(self, rngs=nnx.Rngs(rng))
...
class Pi0Incontextv4(_model.BaseModel):
    def __init__(self, config: Pi0IncontextConfigv4, rngs: nnx.Rngs):
