...
class Pi0LightIncontextConfigv12(_model.BaseModelConfig):
    ...
    @override
    def create(self, rng: at.KeyArrayLike) -> "Pi0LightIncontextv12":
        return Pi0LightIncontextv12(self, rngs=nnx.Rngs(rng))
...
class Pi0LightIncontextv12(_model.BaseModel):
    def __init__(self, config: Pi0LightIncontextConfigv12, rngs: nnx.Rngs):
        ...
        #XJ: debug
        logger.info(f"[Pi0] Prompt Expert config width: {prompt_expert_config.width}")
