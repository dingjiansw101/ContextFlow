...
class Pi0LightIncontextConfigv12SepImgProj(_model.BaseModelConfig):
    ...
    @override
    def create(self, rng: at.KeyArrayLike) -> "Pi0LightIncontextv12SepImgProj":
        return Pi0LightIncontextv12SepImgProj(self, rngs=nnx.Rngs(rng))
...
class Pi0LightIncontextv12SepImgProj(_model.BaseModel):
    def __init__(self, config: Pi0LightIncontextConfigv12SepImgProj, rngs: nnx.Rngs):
        ...
        self.image_proj_prompr_expert = nnx.Linear(siglip_output_dim, prompt_expert_config.width, rngs=rngs)
    ...
    def embed_midfix_causal(
        ...
        for name in obs.images:
            ...
            image_tokens = self.image_proj_prompr_expert(image_tokens)
