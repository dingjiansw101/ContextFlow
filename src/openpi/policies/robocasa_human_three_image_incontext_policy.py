...
def make_robocasa_human_three_image_example() -> dict:
...
class RobocasaHumanThreeImageIncontextInputs(transforms.DataTransformFn):
    """
...
@dataclasses.dataclass(frozen=True)
class RobocasaHumanThreeImageIncontextOutputs(transforms.DataTransformFn):
    """
