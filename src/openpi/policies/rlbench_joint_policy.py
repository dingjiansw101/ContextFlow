...
class RLBenchJointInputs(transforms.DataTransformFn):
    """
    ...
    def __call__(self, data: dict) -> dict:
        ...
        # assert "action_joint_velocity" in data, "action_joint_velocity not  in data"
        if "actions" in data:
            # We are padding to the model action dim.
            
            converted_action = data["actions"]
            actions = transforms.pad_to_dim(converted_action, self.action_dim)
...
@dataclasses.dataclass(frozen=True)
class RLBenchJointOutputs(transforms.DataTransformFn):
    """
