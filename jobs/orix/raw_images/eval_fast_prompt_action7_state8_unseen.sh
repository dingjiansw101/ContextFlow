#!/usr/bin/env bash
#SBATCH --job-name=eval_fast_seq_raw_images
...
export CONFIG="pi0_fast_incontext_prompt_action_7_state_8_train_split"
export POLICY_CONFIG="pi0_fast_incontext_prompt_action_7_state_8_inference"
export JOB_TAG="fast_seq"
