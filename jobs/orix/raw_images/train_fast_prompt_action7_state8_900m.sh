#!/usr/bin/env bash
#SBATCH --job-name=train_fast_seq_900m_raw_images
...
export CONFIG="pi0_fast_incontext_prompt_action_7_state_8_train_split_900m"  # on-disk exp/ckpt name (pre-rename)
export POLICY_CONFIG="ContextAR_900m"  # get_config lookup (renamed)
