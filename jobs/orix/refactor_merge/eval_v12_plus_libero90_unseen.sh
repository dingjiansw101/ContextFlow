#!/usr/bin/env bash
#SBATCH --job-name=eval_v12_plus_libero90_refactor_merge
...
CONFIG="pi0_libero_refactor_incontextv12_low_mem_finetune_sample2_actionssample32_random_select_without_delta_train_split_dataset_refactor_plus_libero90"
POLICY_CONFIG="ContextFlow_Plain_plus_libero90"  # served config (renamed); CONFIG stays old for the on-disk ckpt path
