#!/usr/bin/env bash
#SBATCH --job-name=eval_fast_900m_avg_plus_libero90_refactor_merge
...
CONFIG="pi0_fast_incontext_prompt_action_7_state_8_train_split_900m_avg_demo_img_plus_libero90"
# avg-demo-img checkpoints need the avg inference config (plain inference_900m has
# avg_incontext_image_tokens=False and would mis-evaluate them).
POLICY_CONFIG="pi0_fast_incontext_prompt_action_7_state_8_inference_900m_avg_demo_img"
